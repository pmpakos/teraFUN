...
public final class bookings_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1>\n");
      out.write("                <span data-bind=\"text:bookings().length\"></span> Bookings\n");
      out.write("            </h1>\n");
      out.write("            <table class=\"table\" data-bind=\"visible: bookings().length > 0\">\n");
      ...
      out.write("                    </tr>\n");
      out.write("                </thead>  \n");
      out.write("                <tbody data-bind=\"foreach:bookings\">\n");
      out.write("                    <tr>\n");
      out.write("                        <td>\n");
 ...
 Configuration conf = Configuration.getInstance(); 
      ...
      out.write("             \n");
      out.write("            var Booking = function(id) {\n");
      out.write("                this.id = id;\n");
      out.write("                }\n");
      out.write("\n");
      out.write("            var VM = function(){\n");
      out.write("                this.bookings = ko.observableArray();            \n");
      out.write("            }\n");
      out.write("\n");
      out.write("            VM.prototype.loadBookings = function() {\n");
      out.write("                console.log(\"Loading bookings...\");\n");
      out.write("                var opts = {\n");
      out.write("                    traditional : true,\n");
      out.write("                    cache       : false,\n");
      out.write("                    url         : \"./api/bookings\",\n");
      out.write("                    type        : \"GET\",\n");
      ...
      out.write("\n");
      out.write("            viewModel.loadBookings().done(function(json){\n");
      out.write("                console.log(\"Done loading bookings.\");                 \n");
      out.write("\n");
      out.write("                json.results.forEach(function(bookingJson){             \n");
      out.write("                    var booking = new Booking(\n");
      out.write("                        bookingJson.BookingID,\n");
      out.write("                        );\n");
      out.write("                    console.log(booking);\n");
      out.write("                    viewModel.bookings.push(booking);\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
