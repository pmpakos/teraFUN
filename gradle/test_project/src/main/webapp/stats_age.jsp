...
<!-- ////////////////////////////////////////////////////////// -->
      <div class="container">
      <div id="ko">
            <h1>Στατιστικά εισιτηρίων με βάση την ηλικία : <span ></span> </h1>
            <table id="Data" class="table table-striped table-bordered" >
                <thead class="thead-light">
                    <tr>
                        <th scope="col">0-5 ετών </th>
                         <th scope="col">6-11 ετών </th>
                          <th scope="col">Πάνω από 12 ετών </th>
                    </tr>
                </thead>  
                <tbody>
                    <tr>
                        <td> <span data-bind="text:age1"></span> </td>
                        <td> <span data-bind="text:age2"></span> </td>
                        <td> <span data-bind="text:age3"></span> </td>
    ...
    <script src="js/stats_age.js"></script>
    <script type="text/javascript">
      

var VM = function(){
    this.age1 = ko.observable();
    this.age2 = ko.observable();  
    this.age3 = ko.observable();  
}
...
viewModel.loadEvents().done(function(eventJson){
    console.log("Done loading events."+eventJson.Fun);  
        ...
        viewModel.age1(eventJson.Fun);
        viewModel.age2(eventJson.Education);
        viewModel.age3(eventJson.Sport);
});
