...
public final class company_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1>\n");
      out.write("                <span data-bind=\"text:companies().length\"></span> Companies\n");
      out.write("            </h1>\n");
      out.write("            <table class=\"table\" data-bind=\"visible: companies().length > 0\">\n");
      ...
      out.write("                    </tr>\n");
      out.write("                </thead>  \n");
      out.write("                <tbody data-bind=\"foreach:companies\">\n");
      out.write("                    <tr>\n");
      out.write("                        <td>\n");
 ...
 Configuration conf = Configuration.getInstance(); 
      ...
      out.write("             \n");
      out.write("            var Company = function(id, companyname) {\n");
      out.write("                this.id = id;\n");
      out.write("                this.companyname = companyname;\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            var VM = function(){\n");
      out.write("                this.companies = ko.observableArray();            \n");
      out.write("            }\n");
      out.write("\n");
      out.write("            VM.prototype.loadCompanies = function() {\n");
      out.write("                console.log(\"Loading companies...\");\n");
      out.write("                var opts = {\n");
      out.write("                    traditional : true,\n");
      out.write("                    cache       : false,\n");
      out.write("                    url         : \"./api/companies\",\n");
      out.write("                    type        : \"GET\",\n");
      ...
      out.write("\n");
      out.write("            viewModel.loadCompanies().done(function(json){\n");
      out.write("                console.log(\"Done loading companies.\");                 \n");
      out.write("\n");
      out.write("                json.results.forEach(function(companyJson){             \n");
      out.write("                    var company = new Company(\n");
      out.write("                    \t\tcompanyJson.CompanyID,\n");
      out.write("                    \t\tcompanyJson.CompanyName\n");
      out.write("                        );\n");
      out.write("                    console.log(company);\n");
      out.write("                    viewModel.companies.push(company);\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
