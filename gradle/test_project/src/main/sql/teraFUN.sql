...
--
-- Host: localhost
-- Generation Time: Feb 22, 2018 at 05:22 μμ
...
-- Triggers `booking`
--
DROP TRIGGER IF EXISTS `Ενημέρωση event`;
DELIMITER //
CREATE TRIGGER `Ενημέρωση event` AFTER INSERT ON `booking`
 FOR EACH ROW UPDATE event SET event.TicketCounter = event.TicketCounter + new.NumberOfTickets, event.IncomingCash = event.IncomingCash + (event.Cost * new.NumberOfTickets) WHERE event.EventID = new.EventID
//
DELIMITER ;
...
(4, 'dem21', 'Dem', 'Τροπαίων 4, Αθήνα', 11364, 2106965324, 'dem@hotmail.com', 532532523, 'dem257', 'GR1600012300695011012500000', 'http://www.demathens.gr', '', 1, 588, 'images/user_profiles/dem21/', '38.00563400000000', '23.74470300000000'),
...
(10, 5, 'Εργαστήριο "Μια Αποκριά, μια ιστορία"', 'Αδριανείου 44, Ελληνορώσων', '2018-04-21', '12:00', 30, 6, 360, 60, 'Διαδραστικό εκπαιδευτικό πρόγραμμα από τη myPlace και τη Δημοτική Βιβλιοθήκη Καλλιθέας \r\n\r\nΗ εταιρεία myPlayce, σε συνεργασία με τη Δημοτική Βιβλιοθήκη Καλλιθέας, παρουσιάζει ένα διαδραστικό εκπαιδευτικό πρόγραμμα, με θέμα τις Απόκριες, το Σάββατο 3 Φεβρουαρίου (ώρα 11:30), στη Δημοτική Βιβλιοθήκη Καλλιθέας (Ανδρομάχης 86Α & Αλκμήνης, Καλλιθέα). \r\n\r\nΤο εκπαιδευτικό πρόγραμμα, που έχει σχεδιάσει η θεατρολόγος Μαρία Νομικού και υλοποιεί η ομάδα θεάτρου Δον Κιχώτες, έχει στόχο να μεταφέρει σε μικρούς και μεγάλους την ιστορία της αποκριάς από την Αρχαία Ελλάδα έως τις μέρες μας.', 'images/events/event10', 0, 11, '38.00001700000000', '23.77339800000000', 15, 1, 6, 12, 1, 0, 1, 1, 'ΠΑΙΔΙΑ ΔΗΜΟΤΙΚΟΥ (6 ΕΩΣ ΚΑΙ 12 ΕΤΩΝ), ΠΑΙΔΙΚΕΣ ΑΠΟΚΡΙΑΤΙΚΕΣ ΕΚΔΗΛΩΣΕΙΣ, ΔΩΡΕΑΝ ΠΑΙΔΙΚΕΣ ΕΚΔΗΛΩΣΕΙΣ');
...
(4, 'liva10', 'Μάρκος', 'Λιβαγίνης', 'Δημ. Γούναρη 58 Περιστέρι', 12131, 6944255818, 'marko10@hotmail.com', 'marko21', 0, 0, 627, 5252332442549265, '38.00761700000000', '23.69236300000000', 34567),
