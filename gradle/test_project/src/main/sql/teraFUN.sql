...
--
-- Host: localhost
-- Generation Time: Jan 02, 2018 at 05:50 μμ
...
INSERT INTO `comment` (`CommentID`, `ParentID`, `CompanyID`, `Comment`, `Rate`) VALUES
(1, 6, 5, 'Εκπληκτικός χώρος. Πολύ φιλοκό προσωπικό! Το συνιστώ ΑΝΕΠΙΦΎΛΑΚΤΑ!!!', 5),
(2, 6, 10, '', 3),
(3, 8, 12, NULL, 4),
(4, 9, 4, 'Η κοπέλα που μας εξυπηρέτησε στην είσοδο ήταν αγενής!! Κατά τα άλλα το μέρος είναι συμπαθητικό', 3),
(5, 12, 4, NULL, 5),
(6, 10, 12, NULL, 1),
(7, 5, 6, NULL, 4),
(8, 1, 3, NULL, 5),
(9, 12, 13, 'Οι καθηγητές είναι πολύ ευγενικοί και ακούω τα καλύτερα για τον τρόπο εκπαίδευσης από τα παιδία μου. Είναι από τα καλύτερα φροντιστήρια στην περιοχή!', 5),
(10, 11, 14, NULL, 3);
...
INSERT INTO `event` (`EventID`, `CompanyID`, `Name`, `Address`, `Date`, `Hour`, `TicketCounter`, `IncomingCash`, `Cost`, `Description`, `PhotosFolder`, `Xposition`, `Yposition`, `MaxCapacity`, `Indoor`, `MinAge`, `MaxAge`, `Fun`, `Sport`, `Education`, `Team`, `TagDescription`) VALUES
(4, 4, 'kalosorisma', 'karaolh2', '2017-12-21', '13:00', 0, 0, 10, '', NULL, '\05341.00000000000000', '53443.00000000000000', 100, 1, 0, 12, 1, 1, 1, 1, ''),
(5, 6, 'partaki1', 'papadopoulou 121', '2017-12-31', '12:00', 0, 0, 20, '', NULL, '43234.00000000000000', '843423.00000000000000', 68, 1, 0, 16, 1, 0, 1, 0, ''),
(6, 6, 'paidiko party', 'raxeas6', '2017-12-26', '17:00', 0, 0, 30, '', NULL, '\03113.00000000000000', '121.00000000000000', 100, 0, 5, 10, 1, 1, 1, 0, ''),
(7, 6, 'paidiko party2', 'raxeas82', '2017-12-28', '12:00', 0, 0, 40, '', NULL, '14211.00000000000000', '52352.00000000000000', 100, 1, 10, 15, 1, 1, 1, 1, '');
