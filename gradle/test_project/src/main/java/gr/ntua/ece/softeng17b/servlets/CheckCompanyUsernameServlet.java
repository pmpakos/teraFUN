...
public class CheckCompanyUsernameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckCompanyUsernameServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = company_dao.check_username(username);
		System.out.println("Username: "+ username+" existis ? = "+result);
