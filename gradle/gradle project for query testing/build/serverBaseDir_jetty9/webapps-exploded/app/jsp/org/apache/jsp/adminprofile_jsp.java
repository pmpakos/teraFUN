...
public final class adminprofile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1>\n");
      out.write("                <span data-bind=\"text:adminprofile().length\"></span> AdminProfile\n");
      out.write("            </h1>\n");
      out.write("            <table class=\"table\" data-bind=\"visible: adminprofile().length > 0\">\n");
      ...
      out.write("                    </tr>\n");
      out.write("                </thead>  \n");
      out.write("                <tbody data-bind=\"foreach:adminprofile\">\n");
      out.write("                    <tr>\n");
      out.write("                        <td>\n");
      out.write("                            <span data-bind=\"text:name\"></span>\n");
      out.write("                        </td>\n");
      out.write("                        <td>\n");
      out.write("                            <span data-bind=\"text:amount\"></span>\n");
      out.write("                        </td>\n");
      out.write("                        <td>\n");
 ...
 Configuration conf = Configuration.getInstance(); 
      ...
      out.write("             \n");
      out.write("            var AdminProfile = function(id, name, amount) {\n");
      ...
      out.write("                this.adminprofile = ko.observableArray();            \n");
      out.write("            }\n");
      out.write("\n");
      out.write("            VM.prototype.loadAdminProfile = function() {\n");
      out.write("                console.log(\"Loading adminprofile...\");\n");
      out.write("                var opts = {\n");
      out.write("                    traditional : true,\n");
      out.write("                    cache       : false,\n");
      out.write("                    url         : \"./api/adminprofile\",\n");
      out.write("                    type        : \"GET\",\n");
      ...
      out.write("\n");
      out.write("            viewModel.loadAdminProfile().done(function(json){\n");
      out.write("                console.log(\"Done loading adminprofile.\");                 \n");
      out.write("\n");
      out.write("                json.results.forEach(function(adminprofileJson){             \n");
      out.write("                    var adminprofile = new AdminProfile(\n");
      out.write("                    \tadminprofileJson.AdminProfileID,\n");
      out.write("                    \tadminprofileJson.NameofTeraFun,\n");
      out.write("                    \tadminprofileJson.TotalAmount\n");
      out.write("                        );\n");
      out.write("                    console.log(adminprofile);\n");
      out.write("                    viewModel.adminprofile.push(adminprofile);\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
