...
public final class administrator_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1>\n");
      out.write("                <span data-bind=\"text:administrators().length\"></span> Administrators\n");
      out.write("            </h1>\n");
      out.write("            <table class=\"table\" data-bind=\"visible: administrators().length > 0\">\n");
      ...
      out.write("                    </tr>\n");
      out.write("                </thead>  \n");
      out.write("                <tbody data-bind=\"foreach:administrators\">\n");
      out.write("                    <tr>\n");
      out.write("                        <td>\n");
 ...
 Configuration conf = Configuration.getInstance(); 
      ...
      out.write("             \n");
      out.write("            var Administrator = function(id, firstname, lastname) {\n");
      ...
      out.write("                this.administrators = ko.observableArray();            \n");
      out.write("            }\n");
      out.write("\n");
      out.write("            VM.prototype.loadAdministrators = function() {\n");
      out.write("                console.log(\"Loading administrators...\");\n");
      out.write("                var opts = {\n");
      out.write("                    traditional : true,\n");
      out.write("                    cache       : false,\n");
      out.write("                    url         : \"./api/administrators\",\n");
      out.write("                    type        : \"GET\",\n");
      ...
      out.write("\n");
      out.write("            viewModel.loadAdministrators().done(function(json){\n");
      out.write("                console.log(\"Done loading administrators.\");                 \n");
      out.write("\n");
      out.write("                json.results.forEach(function(administratorJson){             \n");
      out.write("                    var administrator = new Administrator(\n");
      out.write("                        administratorJson.AdminID,\n");
      out.write("                        administratorJson.FirstName,\n");
      out.write("                        administratorJson.LastName\n");
      out.write("                        );\n");
      out.write("                    console.log(administrator);\n");
      out.write("                    viewModel.administrators.push(administrator);\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
