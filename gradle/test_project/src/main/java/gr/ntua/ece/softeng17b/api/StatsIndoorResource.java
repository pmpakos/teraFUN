...
public class StatsIndoorResource extends ServerResource {
	...
	protected Representation get() throws ResourceException {
		...
		int stat_indoor = event_dao.getStatIndoor(id);
		int stat_outdoor = event_dao.getStatOutdoor(id);


		Event event = new Event(0, -1, "", "", null, "", -1, -1, -1, -1, "", "", -1, -1, -1, -1, -1, stat_indoor, -1, -1, stat_outdoor, -1, -1, -1, "");
