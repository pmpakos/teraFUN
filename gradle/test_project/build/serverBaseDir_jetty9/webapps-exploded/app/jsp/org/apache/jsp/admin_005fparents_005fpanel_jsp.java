...
public final class admin_005fparents_005fpanel_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <th scope=\"col\">Κωδικός Εγγραφής</th>\n");
      ...
      out.write("                        <td> <span data-bind=\"text:vcode\"></span> </td>\n");
      out.write("                        <td>\n");
      out.write("                            <button data-bind=\"visible: status==0\" type=\"button\" class=\"btn btn-default btn-admin\">Μη Επαληθευμένος</button>\n");
      out.write("                            <button data-bind=\"visible: status==1\" type=\"button\" class=\"btn btn-default btn-admin\">Ανενεργός</button>\n");
      out.write("                            <button data-bind=\"visible: status==2, click: function(data, event) { change_status(id, 3, data, event) }\" type=\"button\" class=\"btn btn-danger btn-admin\">Block</button>\n");
      out.write("                            <button data-bind=\"visible: status==3, click: function(data, event) { change_status(id, 2, data, event) }\" type=\"button\" class=\"btn btn-info btn-admin\">Unblock</button>\n");
      out.write("                        </td>\n");
      out.write("\n");
      out.write("                    </tr>                   \n");
      out.write("                </tbody>\n");
