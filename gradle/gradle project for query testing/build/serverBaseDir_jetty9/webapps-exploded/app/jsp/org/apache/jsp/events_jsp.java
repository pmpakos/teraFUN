...
public final class events_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1>\n");
      out.write("                <span data-bind=\"text:events().length\"></span> Events\n");
      out.write("            </h1>\n");
      out.write("            <table class=\"table\" data-bind=\"visible: events().length > 0\">\n");
      ...
      out.write("                    </tr>\n");
      out.write("                </thead>  \n");
      out.write("                <tbody data-bind=\"foreach:events\">\n");
      out.write("                    <tr>\n");
      out.write("                        <td>\n");
 ...
 Configuration conf = Configuration.getInstance(); 
      ...
      out.write("             \n");
      out.write("            var Event = function(id, name) {\n");
      out.write("                this.id = id;\n");
      out.write("                this.name = name;\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            var VM = function(){\n");
      out.write("                this.events = ko.observableArray();            \n");
      out.write("            }\n");
      out.write("\n");
      out.write("            VM.prototype.loadEvents = function() {\n");
      out.write("                console.log(\"Loading events...\");\n");
      out.write("                var opts = {\n");
      out.write("                    traditional : true,\n");
      out.write("                    cache       : false,\n");
      out.write("                    url         : \"./api/events\",\n");
      out.write("                    type        : \"GET\",\n");
      ...
      out.write("\n");
      out.write("            viewModel.loadEvents().done(function(json){\n");
      out.write("                console.log(\"Done loading events.\");                 \n");
      out.write("\n");
      out.write("                json.results.forEach(function(eventJson){             \n");
      out.write("                    var event = new Event(\n");
      out.write("                        eventJson.EventID,\n");
      out.write("                        eventJson.Name,\n");
      out.write("                        );\n");
      out.write("                    console.log(event);\n");
      out.write("                    viewModel.events.push(event);\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("\n");
