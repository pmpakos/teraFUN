...
-- Χρόνος δημιουργίας: 09 Ιαν 2018 στις 20:08:41
-- Έκδοση διακομιστή: 5.7.20-0ubuntu0.17.04.1
...
INSERT INTO `parent` (`ParentID`, `Username`, `FirstName`, `LastName`, `Address`, `PostalCode`, `TelephoneNumber`, `Email`, `Password`, `Status`, `CounterEvents`, `Points`, `BankAccount`, `Latitude`, `Longitude`) VALUES
(1, 'nick_nif', 'Nikolaos', 'Nifos', 'Armodiou 24 Kantza', 15351, 2106041245, 'nicknifosgr@gmail.com', 'soeasy2', 1, 0, 310, 2569385547185520, '37.98976600000000', '23.86169800000000'),
(3, 'petros21', 'Πέτρος', 'Μανταλίδης', 'Παναγιώτη Μικρόπουλου 40', 14121, 6985424125, 'mantalos.21@hotmail.com', '21212121', 1, 0, 100, 5135235251352352, '38.04043200000000', '23.76853800000000'),
(4, 'liva10', 'Μάρκος', 'Λιβαγίνης', 'Δημ. Γούναρη 58 Περιστέρι', 12131, 6944255818, 'marko10@hotmail.com', 'marko21', 0, 0, 50, 5252332442549265, '38.00761700000000', '23.69236300000000'),
(5, 'kalverg', 'Καλλιόπη', 'Βεργέτη', 'Αισχύλου 7 Χαλάνδρι', 15234, 2106821253, 'kalverg81@hotmail.com', 'aravia11', 1, 0, 220, 25353253245584, '38.02349300000000', '23.80667600000000'),
(6, 'vagpal22', 'Βαγγέλης', 'Παλαιολόγου', 'Καραϊσκάκη 13 Δάφνη', 17234, 6975439843, 'palaiovag@hotmail.com', 'gasgas', 2, 0, 45, 4352352343523523, '37.95476000000000', '23.73391000000000'),
(7, 'pantelnik', 'Νικηφόρος', 'Παντελιάδης', 'Κων/νου Παλαιολόγου 28, Αθήνα', 10438, 6949876311, 'nikifopante7@hotmail.com', 'olympiakos', 1, 0, 540, 5325233495220169, '37.98858500000000', '23.72219400000000'),
(8, 'kostasthan4', 'Κώστας', 'Θανασόπουλος', 'Ικαρίας 6, Γέρακας', 15344, 2106048598, 'kostasthanaso@yahoo.com', '12fun12', 1, 0, 10, 1654896578965245, '38.01530200000000', '23.85420200000000'),
(9, 'chriskal', 'Χριστίνα', 'Καλογήρου', 'Δαιρπέφελδ 5, Aθήνα', 11144, 6954897126, 'christk84@hotmail.com', 'christ12christ', 1, 0, 85, 6598481532326500, '38.02152700000000', '23.73503500000000'),
(10, 'ismipan', 'Ισμήνη', 'Παναγιωτόπουλου', 'Έκτορος 3 Κηφισιά', 14561, 6974125368, 'ismini73@hotmail.com', 'ismini123pan', 1, 0, 150, 1616200005847822, '38.06888100000000', '23.80061400000000'),
(11, 'dhmixron', 'Δήμητρα-Ελένη', 'Χρονοπούλου', 'Περικλέους 29 Καλλιθέα ', 17673, 6945858030, 'dhmelench@yahoo.com', 'eleni82dimitra', 1, 0, 0, 2023060584126972, '37.95020100000000', '23.69834900000000'),
(12, 'sablil', 'Sabien', 'Lilaj', 'Φιλαδελφέως 24 Αθήνα', 11253, 2104587326, 'sabienlil@hotmail.com', 'sabien24', 1, 0, 35, 6549875410203650, '38.00687000000000', '23.73419300000000');
...
--
ALTER TABLE `parent`
  MODIFY `ParentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
