...
/**
 * Servlet implementation class UploadImageEventServlet
 */

public class UploadImageEventServlet extends HttpServlet {
	    	  ...
	    	  while(itr.hasNext()){
	    		  ...
	    		  if(item.isFormField()){
	    			 ...
	    			 i++;
	    		  		...
	    		  		String username1="event"+username;
	    		  		String temp="events/"+username1;
