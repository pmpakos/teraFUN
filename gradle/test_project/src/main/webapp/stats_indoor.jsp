...
<!-- ////////////////////////////////////////////////////////// -->
      ...
      <div class="container">
      <div id="ko">
            <h1>Στατιστικά εισιτηρίων με βάση το χώρο : <span ></span> </h1>
            <table id="Data" class="table table-striped table-bordered" >
                <thead class="thead-light">
                    <tr>
                        <th scope="col">Εσωτερικού χώρου </th>
                         <th scope="col">Εξωτερικού χώρου </th>
                    </tr>
                </thead>  
                <tbody>
                    <tr>
                        <td> <span data-bind="text:indoor"></span> </td>
                        <td> <span data-bind="text:outdoor"></span> </td>
    ...
    <!-- <script src="js/stats_indoor.js"></script> -->
