...
<html>
  <head>
      <title>Στατιστικά Επισκεψιμότητας | teraFUN</title>
...
<!-- ////////////////////////////////////////////////////////// -->
      ...
      <div class="container">
      <div id="ko">
            <h1>Στατιστικά Επισκεψιμότητας σε Σύνολο Εκδηλώσεων : <span data-bind="text:events().length"></span> </h1>
            <table id="Data" class="table table-striped table-bordered" data-bind="visible: events().length > 0">
                <thead class="thead-light">
                    <tr>
                        <th scope="col">Όνομα </th>
                        <th scope="col">Σύνολο Επισκέψεων </th>
                    </tr>
                </thead>  
    ...
    <!-- <script src="js/total_visits.js"></script> -->
<script type="text/javascript">
  
var Event = function(name, visits) {
    this.name = name;
    this.visits = visits;
}
