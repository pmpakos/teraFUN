	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
	        ...
	        <span class="icon-bar"></span>
				...
				<a href="basics.html" class="navbar-brand"><img src="lalala.png"  class="img-responsive" alt=""/></a>
			</div>
 ...
 <!--   <form name="signUpForm" method="post" action="SignUpParentServlet"> 
  ...
  <form role='form'>
    ...
    <div class="form-group lname">
      ...
      <input type="text" class="form-control addr-validation form-element" name="address" placeholder="Address" data-validation="false">
    </div>  
    ...
    <div class="form-group tel">
      ...
      <input type="text" class="form-control tel-validation form-elementl" name="number" placeholder="Telephone Number" data-validation="false">
    </div>

    <div class="form-group bank">
      <label for="bank"><span class="glyphicon glyphicon-piggy-bank"></span> Bank Account Number</label>
      <input type="text" class="form-control" name="account" id="exampleInput8" placeholder="Bank Account Number" data-validation="false">
    </div>
